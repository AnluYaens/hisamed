...
export interface LandingCopy {
  ...
  cta: {
    heading: string;
    demo: { title: string; body: string; chips: string[]; button: string };
    access: {
      title: string;
      body: string;
      name: string;
  ...
  es: {
    ...
    cta: {
      ...
      demo: {
        ...
        chips: ['6 pacientes ficticios', 'Agenda semanal', 'Notas clínicas'],
  ...
  en: {
    ...
    cta: {
      ...
      demo: {
        ...
        chips: ['6 fictional patients', 'Weekly agenda', 'Clinical notes'],
